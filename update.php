        ...
        <ul class="nav navbar-right top-nav">
          ...
          <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="divider"></li>
                    <li>
                        <a href="update.php?logout='1'"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                    </li>
                </ul>
            </li>
        </ul>
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" action="updatepan.php" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <label for="Applicant">Old PAN Card Number</label>
                                                <input type="text" class="form-control" name="pan" placeholder="Old PAN Card Number">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-3">
                                                ...
                                                <select name="city" class="form-control" id="AO">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <select name="area_code" class="form-control" id="AO">
                                            ...
                                            <div class="col-lg-2">
                                                ...
                                                <select name="aotype" class="form-control" id="AO">
                                            ...
                                            <div class="col-lg-2">
                                                ...
                                                <select name="RangeCode" class="form-control" id="AO">
                                            ...
                                            <div class="col-lg-2">
                                                ...
                                                <select name="AOCode" class="form-control" id="AO">
